...
/*
	if(i == 1)
        	io_prep_pwrite(&iocbp->iocb, fd, buf, RD_WR_SIZE, 1 * RD_WR_SIZE);
	else if (i == 2)
        	io_prep_pwrite(&iocbp->iocb, fd, buf, RD_WR_SIZE, 4 * RD_WR_SIZE);
	else
        	io_prep_pwrite(&iocbp->iocb, fd, buf, RD_WR_SIZE, 7 * RD_WR_SIZE);
*/
